...
/**
 * Context message builder for Cline integration
 * Provides structured context to help Cline make better code modifications
 */
export class ClineMessageBuilder {
  
  /**
   * Build a comprehensive prompt for Cline with all relevant context
   */
  static buildPrompt(options: {
    ...
    sections.push('## Instructions for Cline');
